...
describe("user test cases", ()=>{
    ...
    //Inputs: user: first name: mike, last name: ike, email:mike@gmail.com, password:testpassword1!, isdoctor:true
    ...
    //Inputs: user: first name: james, last name: ola, email:jola@gmail.com, password:testpassword1!, isdoctor:true
